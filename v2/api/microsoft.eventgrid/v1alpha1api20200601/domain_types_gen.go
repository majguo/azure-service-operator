...
// +kubebuilder:rbac:groups=microsoft.eventgrid.azure.com,resources=domains,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=microsoft.eventgrid.azure.com,resources={domains/status,domains/finalizers},verbs=get;update;patch
...
// +kubebuilder:webhook:path=/mutate-microsoft-eventgrid-azure-com-v1alpha1api20200601-domain,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.eventgrid.azure.com,resources=domains,verbs=create;update,versions=v1alpha1api20200601,name=default.v1alpha1api20200601.domains.microsoft.eventgrid.azure.com,admissionReviewVersions=v1beta1
...
// +kubebuilder:webhook:path=/validate-microsoft-eventgrid-azure-com-v1alpha1api20200601-domain,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.eventgrid.azure.com,resources=domains,verbs=create;update,versions=v1alpha1api20200601,name=validate.v1alpha1api20200601.domains.microsoft.eventgrid.azure.com,admissionReviewVersions=v1beta1
...
func (domainStatus *Domain_Status) CreateEmptyARMValue() genruntime.ARMResourceStatus {
...
func (domainsSpec *Domains_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	result.APIVersion = DomainsSpecAPIVersion20200601
	...
	// Set property ‘Type’:
	result.Type = DomainsSpecTypeMicrosoftEventGridDomains
	return result, nil
}

// CreateEmptyARMValue returns an empty ARM value suitable for deserializing into
func (domainsSpec *Domains_Spec) CreateEmptyARMValue() genruntime.ARMResourceStatus {
...
// CreateEmptyARMValue returns an empty ARM value suitable for deserializing into
func (inboundIpRule *InboundIpRule) CreateEmptyARMValue() genruntime.ARMResourceStatus {
...
// CreateEmptyARMValue returns an empty ARM value suitable for deserializing into
func (jsonInputSchemaMapping *JsonInputSchemaMapping) CreateEmptyARMValue() genruntime.ARMResourceStatus {
...
// CreateEmptyARMValue returns an empty ARM value suitable for deserializing into
func (privateEndpointConnectionStatusDomainSubResourceEmbedded *PrivateEndpointConnection_Status_Domain_SubResourceEmbedded) CreateEmptyARMValue() genruntime.ARMResourceStatus {
...
// CreateEmptyARMValue returns an empty ARM value suitable for deserializing into
func (jsonInputSchemaMappingProperties *JsonInputSchemaMappingProperties) CreateEmptyARMValue() genruntime.ARMResourceStatus {
...
// CreateEmptyARMValue returns an empty ARM value suitable for deserializing into
func (jsonField *JsonField) CreateEmptyARMValue() genruntime.ARMResourceStatus {
	return &JsonFieldARM{}
}
...
// CreateEmptyARMValue returns an empty ARM value suitable for deserializing into
func (jsonFieldWithDefault *JsonFieldWithDefault) CreateEmptyARMValue() genruntime.ARMResourceStatus {
