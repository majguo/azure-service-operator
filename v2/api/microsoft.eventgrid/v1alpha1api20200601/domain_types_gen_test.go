...
func RunPropertyAssignmentTestForDomain(subject Domain) string {
	...
	err := subject.AssignPropertiesToDomain(&other)
	if err != nil {
		return err.Error()
	}
...
func RunPropertyAssignmentTestForDomainStatus(subject Domain_Status) string {
	...
	err := subject.AssignPropertiesToDomainStatus(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForDomainStatus(gens map[string]gopter.Gen) {
	...
	gens["ProvisioningState"] = gen.PtrOf(gen.OneConstOf(DomainPropertiesStatusProvisioningStateCanceled, DomainPropertiesStatusProvisioningStateCreating, DomainPropertiesStatusProvisioningStateDeleting, DomainPropertiesStatusProvisioningStateFailed, DomainPropertiesStatusProvisioningStateSucceeded, DomainPropertiesStatusProvisioningStateUpdating))
...
func RunPropertyAssignmentTestForDomainsSpec(subject Domains_Spec) string {
	...
	err := subject.AssignPropertiesToDomainsSpec(&other)
	if err != nil {
		return err.Error()
	}
...
func RunPropertyAssignmentTestForInboundIpRule(subject InboundIpRule) string {
	...
	err := subject.AssignPropertiesToInboundIpRule(&other)
	if err != nil {
		return err.Error()
	}
...
func RunPropertyAssignmentTestForJsonInputSchemaMapping(subject JsonInputSchemaMapping) string {
	...
	err := subject.AssignPropertiesToJsonInputSchemaMapping(&other)
	if err != nil {
		return err.Error()
	}
...
func RunPropertyAssignmentTestForPrivateEndpointConnectionStatusDomainSubResourceEmbedded(subject PrivateEndpointConnection_Status_Domain_SubResourceEmbedded) string {
	...
	err := subject.AssignPropertiesToPrivateEndpointConnectionStatusDomainSubResourceEmbedded(&other)
	if err != nil {
		return err.Error()
	}
...
func RunPropertyAssignmentTestForJsonInputSchemaMappingProperties(subject JsonInputSchemaMappingProperties) string {
	...
	err := subject.AssignPropertiesToJsonInputSchemaMappingProperties(&other)
	if err != nil {
		return err.Error()
	}
...
func RunPropertyAssignmentTestForJsonField(subject JsonField) string {
	...
	err := subject.AssignPropertiesToJsonField(&other)
	if err != nil {
		return err.Error()
	}
...
func RunPropertyAssignmentTestForJsonFieldWithDefault(subject JsonFieldWithDefault) string {
	...
	err := subject.AssignPropertiesToJsonFieldWithDefault(&other)
	if err != nil {
		return err.Error()
	}
