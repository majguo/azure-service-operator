...
type Domains_SpecARM struct {
	...
	//on the template
	APIVersion DomainsSpecAPIVersion `json:"apiVersion"`
	...
	//Type: Resource type
	Type DomainsSpecType `json:"type"`
}
...
func (domainsSpecARM Domains_SpecARM) GetAPIVersion() string {
	return string(domainsSpecARM.APIVersion)
}
...
func (domainsSpecARM Domains_SpecARM) GetType() string {
	return string(domainsSpecARM.Type)
}
...
// +kubebuilder:validation:Enum={"Microsoft.EventGrid/domains"}
type DomainsSpecType string

const DomainsSpecTypeMicrosoftEventGridDomains = DomainsSpecType("Microsoft.EventGrid/domains")
