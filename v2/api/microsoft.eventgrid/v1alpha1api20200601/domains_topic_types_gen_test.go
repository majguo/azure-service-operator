...
func RunPropertyAssignmentTestForDomainsTopic(subject DomainsTopic) string {
	...
	err := subject.AssignPropertiesToDomainsTopic(&other)
	if err != nil {
		return err.Error()
	}
...
func RunPropertyAssignmentTestForDomainTopicStatus(subject DomainTopic_Status) string {
	...
	err := subject.AssignPropertiesToDomainTopicStatus(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForDomainTopicStatus(gens map[string]gopter.Gen) {
	...
	gens["ProvisioningState"] = gen.PtrOf(gen.OneConstOf(DomainTopicPropertiesStatusProvisioningStateCanceled, DomainTopicPropertiesStatusProvisioningStateCreating, DomainTopicPropertiesStatusProvisioningStateDeleting, DomainTopicPropertiesStatusProvisioningStateFailed, DomainTopicPropertiesStatusProvisioningStateSucceeded, DomainTopicPropertiesStatusProvisioningStateUpdating))
...
func RunPropertyAssignmentTestForDomainsTopicsSpec(subject DomainsTopics_Spec) string {
	...
	err := subject.AssignPropertiesToDomainsTopicsSpec(&other)
	if err != nil {
		return err.Error()
	}
