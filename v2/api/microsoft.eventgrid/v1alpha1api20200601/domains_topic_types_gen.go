...
// +kubebuilder:rbac:groups=microsoft.eventgrid.azure.com,resources=domainstopics,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=microsoft.eventgrid.azure.com,resources={domainstopics/status,domainstopics/finalizers},verbs=get;update;patch
...
// +kubebuilder:webhook:path=/mutate-microsoft-eventgrid-azure-com-v1alpha1api20200601-domainstopic,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.eventgrid.azure.com,resources=domainstopics,verbs=create;update,versions=v1alpha1api20200601,name=default.v1alpha1api20200601.domainstopics.microsoft.eventgrid.azure.com,admissionReviewVersions=v1beta1
...
// +kubebuilder:webhook:path=/validate-microsoft-eventgrid-azure-com-v1alpha1api20200601-domainstopic,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.eventgrid.azure.com,resources=domainstopics,verbs=create;update,versions=v1alpha1api20200601,name=validate.v1alpha1api20200601.domainstopics.microsoft.eventgrid.azure.com,admissionReviewVersions=v1beta1
...
func (domainTopicStatus *DomainTopic_Status) CreateEmptyARMValue() genruntime.ARMResourceStatus {
...
func (domainsTopicsSpec *DomainsTopics_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	result.APIVersion = DomainsTopicsSpecAPIVersion20200601
	...
	// Set property ‘Type’:
	result.Type = DomainsTopicsSpecTypeMicrosoftEventGridDomainsTopics
	return result, nil
}

// CreateEmptyARMValue returns an empty ARM value suitable for deserializing into
func (domainsTopicsSpec *DomainsTopics_Spec) CreateEmptyARMValue() genruntime.ARMResourceStatus {
